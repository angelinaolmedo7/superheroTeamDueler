...
def test_team_remove_hero_by_name():
    team = superheroes.Team("One")
    jodie = superheroes.Hero("Jodie Foster")
    team.add_hero(jodie)
    assert team.heroes[0].name == "Jodie Foster"
    team.remove_hero_by_name("Jodie Foster")
    assert len(team.heroes) == 0
...
def test_team_remove_unlisted():
    ...
    jodie = superheroes.Hero("Jodie Foster")
    team.add_hero(jodie)
    code = team.remove_hero(superheroes.Hero("Athena"))
    assert code == 0


def test_team_remove_unlisted_by_name():
    # Test that if no results found return 0
    team = superheroes.Team("One")
    jodie = superheroes.Hero("Jodie Foster")
    team.add_hero(jodie)
    code = team.remove_hero_by_name("Athena")
    assert code == 0
